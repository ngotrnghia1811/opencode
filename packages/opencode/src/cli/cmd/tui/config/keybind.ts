...
export const Definitions = {
  ...
  diff_close: keybind("shift+escape,q", "Close diff viewer"),
  ...
  session_interrupt: keybind("shift+escape", "Interrupt current session"),
  ...
  "prompt.autocomplete.hide": keybind("shift+escape", "Hide autocomplete"),
